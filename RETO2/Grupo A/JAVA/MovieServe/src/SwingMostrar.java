...
/**
* Esta clase llamada SwingMostrar, esta basada o tiende de la superclase de Jframe, por otro lado, la interfaz del action listener también esta implementada en el código y al igual que en los otros archivos, la libreria mysql connector está implementada en el proyecto. 
* Si hacemos inacpié en la funcionalidad de la clase, se trata de una ventana donde se muestra un boton que a la hora de pulsarlo ,nos muestra diversos datos; Telefono, nombre, apellido, dni, email, pelicula, cantidad de asientos y fecha. 
*/
...
* Por último hemos de recalcar que el hemos usado SetLayout null
*/
	SwingMostrar(){
	...
	/**
	* En el actionPerformed, mediante el código de conexión a la base de datos, el uso de una cadena de textos de encabezados, otra tabla y una tabla bidimensional hemos conseguido que se visualicen todos los datos de nuestro interés en 5 distintos registros
	*/
