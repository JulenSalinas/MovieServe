	...
	public void actionPerformed(ActionEvent e) {
	  if (e.getSource()==btnMostrar) {
	   ...
	   // Obtener el primer Nombre
	      ...
	      if (resultSet7.next()) {
	          String asientos1 = resultSet7.getString(1);
	          lblAsientos1.setText(asientos1);
	      }
	      ...
	      if (resultSet8.next()) {
		   ...
		   // Obtener el segundo Nombre
		      ...
		      if (resultSet15.next()) {
		          String asientos2 = resultSet15.getString(1);
		          lblAsientos2.setText(asientos2);
		      }
		   ...
		   // Obtener el tercer Nombre
		      ...
		      if (resultSet23.next()) {
		          String asientos3 = resultSet23.getString(1);
		          lblAsientos3.setText(asientos3);
		      }
		   ...
		   // Obtener el cuarto Nombre
		      ...
		      if (resultSet31.next()) {
		          String asientos4 = resultSet31.getString(1);
		          lblAsientos4.setText(asientos4);
		      }
		   ...
		   // Obtener el quinto Nombre
		      ...
		      if (resultSet41.next()) {
		          String asientos5 = resultSet41.getString(1);
		          lblAsientos5.setText(asientos5);
		      }
